        ...
        <div id="wrapper">
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <!-- Header -->
                    <header id="header">
                        <a href="{$conf->action_url}main" class="logo"><strong>Biblioteka im. Włodzimierza Lenina</strong></a>
                ...
                <div class="inner">
                    ...
                    <nav id="menu">
                        ...
                        <ul>
                            ...
                            <li><a href="{$conf->action_url}opcja3">Wypożyczone książki</a></li>
                            <li><a href="{$conf->action_url}opcja4">Lista książek</a></li>   
                        </ul>
                    </nav>
